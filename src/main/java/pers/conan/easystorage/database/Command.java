...
public interface Command<T> {
    ...
    T update(String table, Structure target, String condition, Object[] args, Class<? extends Structure> structure) throws Exception;

    T update(String table, Collection<? extends Structure> targets, Class<? extends Structure> structure) throws Exception;
